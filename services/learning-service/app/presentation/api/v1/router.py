...
from app.presentation.api.v1.routes.flashcards import router as flashcards_router
from app.presentation.api.v1.routes.health import router as health_router
from app.presentation.api.v1.routes.journal import router as journal_router
